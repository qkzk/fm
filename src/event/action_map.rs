...
pub enum ActionMap {
    ...
    RemoteMount,
    RemovableDevices,
    RemovableDevicesMount,
    RemovableDevicesUmount,
    RemovableDevicesGo,
    Rename,
    ResetMode,
    ReverseFlags,
...
impl ActionMap {
    ...
    pub fn matcher(&self, status: &mut Status, binds: &Bindings) -> Result<()> {
        ...
        match self {
            ...
            Self::EncryptedDriveMount => EventAction::encrypted_mount(status),
            Self::EncryptedDriveUmount => EventAction::encrypted_umount(status),
            Self::EncryptedDriveGo => EventAction::encrypted_go(status),
            ...
            Self::RemovableDevicesMount => EventAction::removable_mount(status),
            Self::RemovableDevicesUmount => EventAction::removable_umount(status),
            Self::RemovableDevicesGo => EventAction::removable_go(status),
