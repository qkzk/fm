...
impl ActionMap {
    ...
    pub fn matcher(&self, status: &mut Status, colors: &Colors) -> Result<()> {
        ...
        match self {
            ...
            ActionMap::BackTab => EventExec::event_backtab(status),
            ...
            ActionMap::GoRoot => EventExec::event_go_root(current_tab),
            ActionMap::GoStart => EventExec::event_go_start(status),
            ...
            ActionMap::ResetMode => EventExec::event_reset_mode(current_tab),
